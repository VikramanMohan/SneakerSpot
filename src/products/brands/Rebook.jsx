...
import ReebokBoxImg1 from "../../assets/reebokboximg.jpg"
import ReebokBoxImg2 from "../../assets/reebokboximg2.jpg"
    ...
    <>
        <div className="pt-16 lg:flex">
                    <div className="w-full lg:w-2/5 " data-aos="fade-up">
                        ...
                        <img src={ReebokBoxImg1} alt="" className="w-full h-[36rem] hover:scale-110 transition-all object-cover" />
                        </div>
                    </div>
