...
import AdidasBoxImg1 from "../../assets/adidasboximg1.jpg";
...
import AdidasBoxImg2 from "../../assets/adidasboximg.jpg";
        ...
        <div className="w-full lg:w-2/5 " data-aos="fade-up">
          <div className="p-5">
            <p className="flex justify-between gap-2 text-white ">
              NIKE WMNS ZOOM AIR FIRE `WHITEUNIVERSITY RED` <HiHeart />{" "}
            </p>
          ...
          <div className="relative overflow-hidden">
            <img
              src={AdidasBoxImg1}
              alt=""
              className="w-full h-[36rem] hover:scale-110 transition-all object-cover"
            />
          </div>
        </div>
            ...
            <div className="relative flex items-center justify-center h-64 overflow-hidden bg-gradient-to-r from-red-400 to-orange-300 ">
              <div className="flex items-center justify-center ">
                <img
                  src={AdidasImg3}
                  alt=""
                  className="mt-5 transition-all w-60 hover:scale-110"
                />
              </div>
              <div className="absolute flex items-center justify-between w-full px-6 top-6">
          ...
          <div className="bg-[#232227] h-64 flex justify-center items-center relative ">
            <div className="relative flex items-center justify-center top-2">
              <img
                src={AdidasImg4}
                alt=""
                className="w-[70%] transition-all hover:scale-110"
              />
            </div>
            <div className="absolute flex items-center justify-between w-full px-6 top-6">
              <p className="text-white ">STREAT</p>
          ...
          <div className="lg:flex lg:pb-40">
            ...
            >
              <p className="flex justify-between gap-2 px-6 pt-6 text-white">
                ADIDAS RYX 360 ORIGINAL <HiHeart />
              </p>
