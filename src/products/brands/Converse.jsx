...
import ConverseBoxImg1 from "../../assets/converseboximg1.jpg"
import ConverseBoxImg2 from "../../assets/converseboximg.jpg"
    ...
    <>
        <div className="pt-16 lg:flex">
                    <div className="w-full lg:w-2/5 " data-aos="fade-up">
                        ...
                        <img src={ConverseBoxImg1} alt="" className="w-full h-[36rem] hover:scale-110 transition-all object-cover" />
                        </div>
                    </div>
